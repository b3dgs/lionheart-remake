 ...
 */
public final class LaserAirshipPropertyTester extends PropertyTester
{
    /** Can enable property. */
     ...
     * Create tester.
     */
    public LaserAirshipPropertyTester()
    {
        super();
    }
    ...
    {
        final LaserAirshipPart part = UtilPart.getPart(LaserAirshipPart.ID, LaserAirshipPart.class);
