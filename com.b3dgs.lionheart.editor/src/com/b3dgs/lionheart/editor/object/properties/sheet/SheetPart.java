 ...
 */
public class SheetPart extends PartAbstract<SheetConfig, Sheet>
{
    /** Id. */
    public static final String ID = ID_PREFIX + "sheet";
    ...
    public SheetPart()
    {
        super(SheetConfig.class, Sheet.class, SheetEditor.class);
    }
}
