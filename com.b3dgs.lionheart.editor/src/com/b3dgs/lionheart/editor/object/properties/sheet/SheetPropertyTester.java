 ...
 */
public final class SheetPropertyTester extends PropertyTester
{
    /** Can enable property. */
    ...
    {
        final SheetPart part = UtilPart.getPart(SheetPart.ID, SheetPart.class);
