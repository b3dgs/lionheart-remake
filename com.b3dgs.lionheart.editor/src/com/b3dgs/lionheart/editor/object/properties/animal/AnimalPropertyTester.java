 ...
 */
public final class AnimalPropertyTester extends PropertyTester
{
    /** Can enable property. */
    ...
    {
        final AnimalPart part = UtilPart.getPart(AnimalPart.ID, AnimalPart.class);
