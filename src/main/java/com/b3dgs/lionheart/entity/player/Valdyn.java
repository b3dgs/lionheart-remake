        ...
        extends EntityMover
{
    ...
    public Valdyn(SetupSurfaceRasteredGame setup)
    {
        ...
        fallenDuration = configurable.getInteger("fallenDuration", "data");
        movementSpeedMax = configurable.getDouble("speedMax", "data", "movement");
        movementSmooth = configurable.getDouble("smooth", "data", "movement");
        sensibilityIncrease = configurable.getDouble("sensibilityIncrease", "data", "movement");
        sensibilityDecrease = configurable.getDouble("sensibilityDecrease", "data", "movement");
        loadCollisions(configurable, ValdynCollision.values());
        loadAnimations(configurable, ValdynState.values());
