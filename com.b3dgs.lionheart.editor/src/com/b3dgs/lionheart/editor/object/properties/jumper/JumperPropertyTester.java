 ...
 */
public final class JumperPropertyTester extends PropertyTester
{
    /** Can enable property. */
    ...
    {
        final JumperPart part = UtilPart.getPart(JumperPart.ID, JumperPart.class);
