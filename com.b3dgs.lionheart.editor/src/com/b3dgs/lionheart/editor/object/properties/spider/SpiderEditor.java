 ...
 * Editor dialog.
 */
public class SpiderEditor extends EditorAbstract
{
    /** Dialog icon. */
    ...
    private Optional<SpiderConfig> output = Optional.empty();
    ...
    protected void createContent(Composite parent)
    {
        ...
        follow = UtilButton.createCheck(UtilConversion.toTitleCase(SpiderConfig.ATT_FOLLOW), content);
     ...
     * @return The output.
     */
    public Optional<SpiderConfig> getOutput()
    {
        return output;
    }
}
