...
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.ITEM, ThemeType.SWAMP, PotionLittle.class);
     ...
     */
    public PotionLittle(SetupSurfaceRasteredGame setup)
    {
        super(setup);
    }
