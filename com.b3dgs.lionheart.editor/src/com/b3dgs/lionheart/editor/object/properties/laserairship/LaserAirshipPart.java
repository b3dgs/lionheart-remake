 ...
 */
public class LaserAirshipPart extends PartAbstract<LaserAirshipConfig, LaserAirship>
{
    /** Id. */
    public static final String ID = ID_PREFIX + "laserairship";

    /**
     * Create part.
     */
    public LaserAirshipPart()
    {
        super(LaserAirshipConfig.class, LaserAirship.class, LaserAirshipEditor.class);
    }
}
