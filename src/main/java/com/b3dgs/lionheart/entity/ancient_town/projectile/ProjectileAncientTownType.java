 ...
 */
public enum ProjectileAncientTownType implements ProjectileType<ProjectileAncientTownType>
{
    ;
     ...
     */
    private ProjectileAncientTownType(Class<?> target)
    {
        this.target = target;
    ...
    @Override
    public ProjectileAncientTownType getType()
    {
        return this;
    }
}
