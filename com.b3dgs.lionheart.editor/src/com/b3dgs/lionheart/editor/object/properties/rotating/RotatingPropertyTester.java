 ...
 */
public final class RotatingPropertyTester extends PropertyTester
{
    /** Can enable property. */
    ...
    {
        final RotatingPart part = UtilPart.getPart(RotatingPart.ID, RotatingPart.class);
