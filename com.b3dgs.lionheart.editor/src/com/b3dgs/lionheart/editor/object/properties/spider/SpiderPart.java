 ...
 */
public class SpiderPart extends PartAbstract<SpiderConfig, Spider>
{
    /** Id. */
    public static final String ID = ID_PREFIX + "spider";
    ...
    public SpiderPart()
    {
        super(SpiderConfig.class, Spider.class, SpiderEditor.class);
    }
}
