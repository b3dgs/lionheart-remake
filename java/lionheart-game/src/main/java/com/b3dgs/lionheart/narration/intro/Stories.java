 ...
 * Intro stories.
 */
public final class Stories extends StoriesBase
{
    ...
    private static Media get(String pic)
    {
        return Medias.create(Folder.INTRO, PART4, pic);
    }
    ...
    public Stories(int width, int height)
    {
        ...
        add(new StoryRenderer(get("pic1.png"), offsetX + 45, 20, texts[1], offsetX + 1, 118));
        add(new StoryRenderer(get("pic2.png"), offsetX + 90, 40, texts[2], offsetX + 1, 138));
        add(new StoryRenderer(get("pic3.png"), offsetX + 135, 60, texts[3], offsetX + 1, 158));
