 ...
 */
public final class PatrollerModel
        implements PatrollerServices
{
    /** Entity owner. */
    private final PatrollerUsedServices owner;
     ...
     */
    public PatrollerModel(PatrollerUsedServices owner)
    {
        this.owner = owner;
