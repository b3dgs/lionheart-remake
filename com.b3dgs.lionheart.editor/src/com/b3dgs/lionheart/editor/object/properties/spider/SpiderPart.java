 ...
 */
public class SpiderPart implements Focusable, PropertiesFeature
{
    /** Id. */
    public static final String ID = Activator.PLUGIN_ID + ".part.properties.spider";
    /** Menu. */
    ...
    public void enable()
    {
        if (spider.getConfig() == null)
        {
            final TreeItem item = new TreeItem(tree, SWT.NONE);
            spider.setConfig(new SpiderConfig());
            item.setText(spider.getConfig().toString());
        }
    }
    ...
    {
        UtilPart.getMPart(SpiderPart.ID).setVisible(true);
        ...
        tree.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseDoubleClick(MouseEvent event)
            {
                ...
                if (items.length > 0)
                {
                    ...
                    final SpiderEditor editor = new SpiderEditor(tree, spider.getConfig());
                    editor.create();
                    editor.openAndWait();
