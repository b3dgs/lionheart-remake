...
public final class ValdynAttack
{
    ...
    ValdynAttack(Configurer configurer, Valdyn valdyn, Movement movement)
    {
        ...
        addShadeAnimation(configAnimations, ValdynState.ATTACK_TURNING, 2);
        addShadeAnimation(configAnimations, ValdynState.ATTACK_JUMP, 1);
        addShadeAnimation(configAnimations, ValdynState.ATTACK_SLIDE, 1);
        addShadeAnimation(configAnimations, ValdynState.ATTACK_LIANA, 1);
        addShadeAnimation(configAnimations, ValdynState.ATTACK_GROUNDHOOCKABLE, 2);
    }
