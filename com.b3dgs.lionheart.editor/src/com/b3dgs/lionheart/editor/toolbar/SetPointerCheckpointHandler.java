...
/**
 * Set pointer checkpoint handler.
 */
public final class SetPointerCheckpointHandler
{
    /** Element ID. */
    public static final String ID = PaletteModel.ID_PREFIX + "pointer-checkpoint";

    /**
     * Create handler.
     */
    public SetPointerCheckpointHandler()
    {
        super();
    }
    ...
    public void execute(EPartService partService)
    {
        ...
        final PaletteType type = PaletteType.POINTER_CHECKPOINT;
