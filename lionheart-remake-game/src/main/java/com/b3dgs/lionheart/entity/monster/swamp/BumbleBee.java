...
import com.b3dgs.lionheart.entity.monster.EntityMonsterBee;
...
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.MONSTER, ThemeType.SWAMP, BumbleBee.class);
     ...
     */
    public BumbleBee(SetupSurfaceRasteredGame setup)
    {
        super(setup);
    }
}
