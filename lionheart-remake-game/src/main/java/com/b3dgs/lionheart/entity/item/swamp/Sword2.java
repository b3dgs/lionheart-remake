...
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.ITEM, ThemeType.SWAMP, Sword2.class);
     ...
     */
    public Sword2(SetupSurfaceRasteredGame setup)
    {
        super(setup);
    }
