 ...
 */
public class JumperPart extends PartAbstract<JumperConfig, Jumper>
{
    /** Id. */
    public static final String ID = ID_PREFIX + "jumper";
    ...
    public JumperPart()
    {
        super(JumperConfig.class, Jumper.class, JumperEditor.class);
    }
}
