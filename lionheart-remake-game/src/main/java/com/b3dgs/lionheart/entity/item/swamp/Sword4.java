...
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.ITEM, ThemeType.SWAMP, Sword4.class);
     ...
     */
    public Sword4(SetupSurfaceRasteredGame setup)
    {
        super(setup);
    }
