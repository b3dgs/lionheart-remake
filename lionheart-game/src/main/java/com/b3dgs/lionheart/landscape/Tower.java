 ...
 */
final class Tower extends BackgroundAbstract
{
     ...
     */
    Tower(SourceResolutionProvider source, double scaleH, double scaleV, String theme, boolean flickering)
    {
        super(theme, 0, 2448);

        final String path = UtilFolder.getPath(Folder.BACKGROUNDS, "tower", theme);
