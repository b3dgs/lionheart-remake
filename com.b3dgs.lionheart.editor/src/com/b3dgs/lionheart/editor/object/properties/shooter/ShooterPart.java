 ...
 */
public class ShooterPart implements Focusable, PropertiesFeature
{
    /** Id. */
    public static final String ID = Activator.PLUGIN_ID + ".part.properties.shooter";
    /** Menu. */
    ...
    public void enable()
    {
        if (shooter.getConfig() == null)
        {
            final TreeItem item = new TreeItem(tree, SWT.NONE);
            shooter.setConfig(new ShooterConfig());
            item.setText(shooter.getConfig().toString());
        }
    }
    ...
    {
        UtilPart.getMPart(ShooterPart.ID).setVisible(true);
        ...
        tree.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseDoubleClick(MouseEvent event)
            {
                ...
                if (items.length > 0)
                {
                    ...
                    final ShooterEditor editor = new ShooterEditor(tree, shooter.getConfig());
                    editor.create();
                    editor.openAndWait();
