 ...
 */
public class GeyzerPart extends PartAbstract<GeyzerConfig, Geyzer>
{
    /** Id. */
    public static final String ID = ID_PREFIX + "geyzer";
    ...
    public GeyzerPart()
    {
        super(GeyzerConfig.class, Geyzer.class, GeyzerEditor.class);
    }
}
