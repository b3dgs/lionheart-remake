...
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.MONSTER, ThemeType.SWAMP, Flower.class);

    /** Launcher bullet. */
    private LauncherBullet launcher;
     ...
     */
    public Flower(SetupSurfaceRasteredGame setup)
    {
        super(setup);
    }
    ...
    public void prepare(ContextGame context)
    {
        ...
        final FactoryLauncher factoryLauncher = context.getService(FactoryLauncher.class);
        launcher = factoryLauncher.create(LauncherBullet.MEDIA);
