 ...
 */
public final class Dragon1PropertyTester extends PropertyTester
{
    /** Can enable property. */
    ...
    {
        final Dragon1Part part = UtilPart.getPart(Dragon1Part.ID, Dragon1Part.class);
